...
const description =
  "Who we are: a small Ludhiana studio that makes school charts, models, files and craft projects for students, prepared neatly and on time.";
      ...
      >
        <div className="grid gap-8 lg:grid-cols-3">
          <article className="rounded-lg border border-border bg-card p-6 lg:col-span-2">
            ...
            <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
              Chart paper projects, working and still models, written project files and craft work
              for school activities. Every item is made for the topic and class the school has
              assigned. See the{" "}
              <Link
                to="/services"
